...
public class FileUtils {
    ...
    //移除相同
    public static List<MusicDirectoryEntity> removeDuplicate(List<MusicDirectoryEntity> list) {

        Set set = new HashSet();
        List<MusicDirectoryEntity> newList = new ArrayList<>();
        Iterator it = list.iterator();
        while (it.hasNext()){
            MusicDirectoryEntity object = (MusicDirectoryEntity) it.next();
